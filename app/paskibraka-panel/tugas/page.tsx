            ...
            <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                        Daftar instruksi dan tugas bulanan yang diberikan oleh Pembina/Admin. Pastikan kumpulkan sebelum tenggat waktu berakhir.
                    </p>
                </div>
                                ...
                                >
                                    <div className="space-y-3">
                                        ...
                                        {task.file_lampiran && (
                                            <div className="pt-2">
                                                <a
                                                    href={`${UrlApi}/${task.file_lampiran}`}
                                                    target="_blank"
                                    ...
                                    <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-700/60 flex items-center justify-between">
                                        ...
                                        {!status.isExpired ? (
                                            <Link
                                                ...
                                                className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-semibold text-xs rounded-xl shadow transition flex items-center gap-1.5"
                                            >
                                            ...
                                            <span className="text-xs font-semibold text-slate-400 bg-slate-100 dark:bg-slate-700 px-3 py-1.5 rounded-xl">
                                                Tugas Ditutup
                                            </span>
                                        )}
                                    </div>
