                        ...
                        <SwiperSlide key={item.id}>
                            <div className='text-center px-auto mx-auto justify-center align-middle overflow-hidden bg-black'>
                                <a href={`/berita/${item.slug}`}>
                                    <Image className='w-full max-h-[700px] align-middle bg-no-repeat object-cover opacity-90' src={BaseUrl + `${item.photo}`} alt='photo berita' width={400} height={200} onError={(e: any) => { e.target.onerror = null; e.target.src = "https://placehold.co/600x400/757575/000000?text=Gagal+Memuat+gambar" }} />
