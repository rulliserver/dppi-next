...
//         // Add background color untuk seluruh halaman
//         doc.setFillColor(255, 248, 248);
//         doc.rect(0, 0, 210, 297, 'F');

//         // Header dengan gradient background MERAH
...
//         if (pdp.no_simental) {
//             doc.text(`NRA: ${pdp.no_simental}`, 105, 30, { align: 'center' });
//         }
//         if (pdp.no_piagam) {
//             doc.text(`Nomor Piagam: ${pdp.no_piagam}`, 105, 36, { align: 'center' });
//         }
...
//                     doc.addImage(base64Image, 'JPEG', 22.5, yPosition + 2, 35, 44);

//                     // Add name under photo
//                     doc.setTextColor(185, 28, 28);
//                     doc.setFontSize(8);
//                     doc.setFont('helvetica', 'bold');
//                     const nameLines = doc.splitTextToSize(pdp.nama_lengkap, 41);
//                     doc.text(nameLines, 42.5, yPosition + 58, { align: 'center' });
//                 }
//             } catch (error) {
...
//                 doc.setFontSize(6);
//                 doc.text('No Photo', 42.5, yPosition + 28, { align: 'center' });
//                 doc.text(pdp.nama_lengkap, 42.5, yPosition + 58, { align: 'center' });
//             }
//         }
...
//         doc.setDrawColor(185, 28, 28);
//         doc.rect(flexStartX - 10, yPosition, flexWidth + 10, 85, 'F');
//         doc.rect(flexStartX - 10, yPosition, flexWidth + 10, 85, 'S');
...
//                 disabled={generating}
//                 className='mx-2 px-4 py-2 rounded-md bg-red-600 text-white hover:bg-red-700 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed'
//             >
//                 {generating ? (
//                     <>
...
//                 disabled={generating}
//                 className='mx-2 px-4 py-2 rounded-md bg-red-700 text-white hover:bg-red-800 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed'
//             >
//                 {generating ? (
//                     <>
//                         <i className='fas fa-spinner fa-spin mr-2'></i>
